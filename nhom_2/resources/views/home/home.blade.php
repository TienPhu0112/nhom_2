        ...
        <div class="row">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav main-nav  clear navbar-right ">
                    <li><a class="navactive color_animation" href="{{asset('/')}}">WELCOME</a></li>
                    <li><a class="color_animation" href="#">ABOUT</a></li>
                    <li><a class="color_animation" href="#">PRICING</a></li>
                    <li><a class="color_animation" href="#">FEATURED</a></li>
    ...
    <div class="text-content container">
        ...
        <div class="col-md-6">
            <div class="img-section">
                ...
                <img src="{{asset($food->image)}}" width="250" height="220">
                @endforeach
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div id="w">
                    <ul id="filter-list" class="clearfix">
                        ...
                        <li class="filter" data-filter=".{{$type->name}}">{{$type->name}}</li>
                        @endforeach
                    </ul><!-- @end #filter-list -->
                    <ul id="portfolio">
                        @foreach($lsFood as $food)
                            <li class="item {{$food->name}} mix_all" style="display: inline-block;  opacity: 1;"><img src="{{asset($food->image)}}" alt="Food">
