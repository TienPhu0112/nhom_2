                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                ...
                                <!-- Button2 -->
                                <a href="{{asset('/menu')}}" class="btn2 flex-c-m txt5 ab-c-m size5">
                                    Dinner
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                ...
                                <!-- Button2 -->
                                <a href="{{asset('/menu')}}" class="btn2 flex-c-m txt5 ab-c-m size6">
                                    Happy Hour
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                ...
                                <!-- Button2 -->
                                <a href="{{asset('/menu')}}" class="btn2 flex-c-m txt5 ab-c-m size7">
                                    Drink
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                ...
                                <!-- Button2 -->
                                <a href="{{asset('/menu')}}" class="btn2 flex-c-m txt5 ab-c-m size8">
                                    Starters
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                ...
                                <!-- Button2 -->
                                <a href="{{asset('/menu')}}" class="btn2 flex-c-m txt5 ab-c-m size9">
                                    Dessert
                                </a>
                            </div>
                        </div>
